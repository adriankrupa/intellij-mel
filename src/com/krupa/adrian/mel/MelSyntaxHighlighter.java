...
public class MelSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public Lexer getHighlightingLexer() {
        return new MelLexerAdapter();
    }

    @NotNull
    @Override
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(MelTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(MelTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(MelTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(MelTypes.COMMENT)) {
            return COMMENT_KEYS;
